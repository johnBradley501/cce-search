...
* the bottom left frame (which displays details about clerty) is specified initially at least in `text.html`.
...
and was unncessary.  Although it is still in this directory, it is no longer used.
